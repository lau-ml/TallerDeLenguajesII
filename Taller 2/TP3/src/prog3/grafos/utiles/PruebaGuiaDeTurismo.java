...
public class PruebaGuiaDeTurismo {
	public static void main(String[] args) {
		GuiaDeTurismo<String> guiaTurismo=new GuiaDeTurismo<String>();
		...
		System.out.println(guiaTurismo.caminoConMenorNrodeViajes(grafo, "1", "7"));
	}
}
