...
/**
 * La clase calendario tiene asociada la cantidad de días que duran los juegos, una fecha de inicio y tiene asociado un
 * conjunto de nodos calendarios al cual le delega la responsabilidad de agregar o quitar información en cuanto a la fecha de realización de una determinada ronda.
 * A su vez, la clase calendario es capaz de acceder a la información que el nodo calendario almacena.
 * @author Lautaro
...
public class Calendario {
	...
	/**
	 * Convierte a una fecha válida para poder acceder a cada uno de los nodos calendarios
	 * @param fecha Recibe una fecha 
	 * @return Devulve la posición correspondiente a la posición del vector de nodos calendario
	 */
	private int calcularPosicion(Fecha fecha) {
		return (fecha.getDia() + (fecha.getMes() - fechaInicio.getMes()) * 30 - fechaInicio.getDia());
	}
	/**
	 * Se encarga de crear un vector de nodos calendario, obteniendo su dimensión a partir de obtener una fecha válida.
...
/**
 * Se encarga de pedile a nodocalendario, que borre la información que tenía respecto a una determinada ronda y la actualice
 * con una nueva fecha
 ...
 */
	...
	/**
	 * El método se encarga de devolver una lista de rondas, a partir de un pedido al nodo correspondiente con la fecha.
 ...
 * @return Un cronograma del tipo calendario con la información recolectada de la sede.
 */
	...
	/**
	 * Obtiene un nodo calendario que tiene información acerca de una sede en un determinado día
