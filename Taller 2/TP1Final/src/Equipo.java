...
/**
 * Esta clase busca representar a cada uno de los equipos participantes de cada
 * delegación. Esta tiene por tanto, una lista de atletas, una delegación a la
 * cual representa y puede llegar a tener o no un entrenador . El equipo,
 * también representa a aquellos atletas que compiten de forma individual. Es
 * decir, un deportista que compite solo en Judo, se considera como un equipo de
 * 1 integrante
 * 
...
public class Equipo {
	 ...
	 * 
	 * @return int Devuelve el tamaño de la lista de atletas
	 */
	 ...
	 * 
	 * @return ListaGenerica<Atleta> Devuelve la lista de atletas
	 */
	 ...
	 * 
	 * @return Delegacion Devuelve una delegación
	 */
	 ...
	 * 
	 * @return Entrenador En caso de que haya un entrenador, lo devuelve, en caso
	 ...
	 * @return boolean Devuelve verdadero en caso de que se haya podido inscribir,
	 ...
	 * 
	 * @param atleta Recibe un determinado atleta
	 * @return boolean Devuelve verdadero en caso de que se haya podido eliminar
	 ...
	 * 
	 * @return boolean Devuelve true en caso de que esté asignado un entrenador,
	 *         falso en caso contrario
	 */
	 ...
	 * 
	 * @return boolean Devuelve el tamaño de la lista de atletas
	 */
